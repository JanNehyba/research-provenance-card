...
| File | What it is |
|---|---|
| [`round2-submission-en.md`](./round2-submission-en.md) | **Canonical submission.** Paste-ready, question by question (1A–6), with recommended tick-box answers marked ▶ and three appendices. |
